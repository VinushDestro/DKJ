...
//    private JFXTextField condi;
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       view.getItems().addAll("View_All","Available","Repair");
    ...
    LocalDate bDate = bouDate.getValue();
     //  int lifT=Integer.parseInt(liTime.getText().trim());
        ...
        String calc=dep.getText().trim();
            ...
            alert.setHeaderText(null);
            alert.setContentText("RegNo already exists");
            alert.show();
...
//        } 
//       try { 
//          if ( lifT.isEmpty() || cond.isEmpty() || !rNo.isEmpty()) {
...
//
//        if (TenderManagement.checkOngoing(tenderId.getText())) {
//            alertboxWarn("Alert", "Can not delete Ongoing Tender..!!");
//            return;
//        }
//        
//        if(TenderManagement.checkRequired(tenderId.getText()) && alertboxConfirm("Delete Tender", "Some requirements will be deleted from this Tender... Do you really want to Delete ?") )
//        {
//            deleterequired();
//            deleteClicked();
//            return;
   ...
   public void doView() {
         ...
         try {  //String v = view.getPromptText().trim();
            ...
            avai.setVisible(true);
             ...
             else if ((String) view.getValue()=="View_All"){vehicleTab.setItems(VehicleManagement.getVehicle());
              rep.setVisible(false);
              avai.setVisible(false);
             }
        } catch (Exception e) {
...
private void updateLoad() throws IOException, ClassNotFoundException, SQLException{
 ...
 private void RowclickEvent() {
        vehicleTab.setOnMouseClicked(new EventHandler<MouseEvent>() {
         ...
         try{       VehicleDetail tab = vehicleTab.getItems().get(vehicleTab.getSelectionModel().getSelectedIndex());
...
//            else{
                ...
                else if ((String) view.getValue()=="Available" || (String) view.getValue()=="Repair")  {
                    PreparedStatement pst = con.prepareStatement
                             ("select * from asset where name like '%" + search.getText() + "%' and availability = '"+ (String) view.getValue()+ "'"
