...
// creating objects and load it in
     ...
     public static ObservableList<VehicleDetail> getAssignedVehicle() throws IOException, ClassNotFoundException, SQLException {
        ObservableList<VehicleDetail> Vehicle = FXCollections.observableArrayList();
        ...
        ResultSet rs = stmt.executeQuery("select * from asset where availability = 'assigned'");
