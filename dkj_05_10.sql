...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 05, 2017 at 11:42 AM
...
(2, 'kamal', 'galle', '451236987v', '2017-10-04', 'male', '0773225455', 'employee', 'permanent', 23400, 'available');
...
INSERT INTO `equipment` (`name`, `count`, `cost`, `availability`, `date`) VALUES
('hammer', 10, 2300, 'available', '2017-10-05 16:44:03'),
('sD', 12, 13, 'available', '2017-10-02 18:40:20'),
('spade', 23, 1000, 'available', '2017-10-05 16:44:03');
...
(3, 'kt3102', 'At0a1', 'kandy', '2017-09-20', 6700),
...
ALTER TABLE `equiptender`
  ...
  ADD CONSTRAINT `equiptender_ibfk_2` FOREIGN KEY (`equipName`) REFERENCES `equipment` (`name`);
